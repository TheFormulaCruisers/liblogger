...
SOURCEFILES_QUOTED_IF_SPACED=../../src/logger.c ../../tests/logger_tests.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1445274692/logger.o ${OBJECTDIR}/_ext/1635097729/logger_tests.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1445274692/logger.o.d ${OBJECTDIR}/_ext/1635097729/logger_tests.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1445274692/logger.o ${OBJECTDIR}/_ext/1635097729/logger_tests.o

# Source Files
SOURCEFILES=../../src/logger.c ../../tests/logger_tests.c

# Pack Options 
PACK_COMPILER_OPTIONS=-I ${DFP_DIR}/include
PACK_COMMON_OPTIONS=-B ${DFP_DIR}/gcc/dev/at90can128
...
${OBJECTDIR}/_ext/1635097729/logger_tests.o: ../../tests/logger_tests.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1635097729" 
	@${RM} ${OBJECTDIR}/_ext/1635097729/logger_tests.o.d 
	@${RM} ${OBJECTDIR}/_ext/1635097729/logger_tests.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=at90can128 ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"../../inc" -funsigned-char -funsigned-bitfields -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/_ext/1635097729/logger_tests.o.d" -MT "${OBJECTDIR}/_ext/1635097729/logger_tests.o.d" -MT ${OBJECTDIR}/_ext/1635097729/logger_tests.o  -o ${OBJECTDIR}/_ext/1635097729/logger_tests.o ../../tests/logger_tests.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
dist/${CND_CONF}/${IMAGE_TYPE}/mplabx.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mmcu=at90can128 ${PACK_COMMON_OPTIONS}  -D__$(MP_PROCESSOR_OPTION)__  -Wl,-Map="dist/${CND_CONF}/${IMAGE_TYPE}/mplabx.${IMAGE_TYPE}.map"    -o dist/${CND_CONF}/${IMAGE_TYPE}/mplabx.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION) -Wl,--gc-sections -Wl,--start-group  -Wl,-lm -Wl,--end-group 
	${MP_CC_DIR}/avr-objcopy -O ihex "dist/${CND_CONF}/${IMAGE_TYPE}/mplabx.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "dist/${CND_CONF}/${IMAGE_TYPE}/mplabx.${IMAGE_TYPE}.hex"
